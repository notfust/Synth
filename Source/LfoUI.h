...
class LfoComponent : public BasicComponent
{
public:
    LfoComponent(APVTS& apvts, String lfoFreqId, String lfoDepthId);
...
private:
    ...
    void setSliderParams(Slider& slider, Label& label, std::unique_ptr<SliderAttachment>& attachment, String paramId, APVTS& apvts);
