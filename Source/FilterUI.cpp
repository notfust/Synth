...
FilterComponent::FilterComponent(APVTS& apvts, String filterTypeId, String cutoffId, String resonanceId)
  : cutoff("CUTOFF", cutoffId, apvts, dialWidth, dialHeight), resonance("RESONANCE", resonanceId, apvts, dialWidth, dialHeight)
{
