...
public:
    ...
    SliderWithLabel(String labelName, String paramId, APVTS& apvts, const int width, const int height, SliderStyle style = SliderStyle::RotaryHorizontalVerticalDrag);
